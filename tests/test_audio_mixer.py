...
class AudioMixerTests(unittest.TestCase):
    def test_single_track_audio_is_normalized_without_mix(self) -> None:
        self.assertEqual(
            build_audio_filter_complex(track_count=1),
            "[0:a]volume=1.0000,loudnorm=I=-16:TP=-1.5:LRA=11[out]",
        )
    ...
    def test_two_track_audio_is_normalized_and_mixed(self) -> None:
        ...
        self.assertIn("[0:a]volume=1.0000,loudnorm=I=-16:TP=-1.5:LRA=11[a0]", filter_graph)
